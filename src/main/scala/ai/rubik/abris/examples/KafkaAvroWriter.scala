...
package ai.rubik.abris.examples

import ai.rubik.abris.avro.format.SparkAvroConversions
import ai.rubik.abris.avro.parsing.utils.AvroSchemaUtils
import ai.rubik.abris.avro.read.confluent.SchemaManager
import ai.rubik.abris.examples.data.generation.ComplexRecordsGenerator
import org.apache.spark.sql.catalyst.encoders.RowEncoder
import org.apache.spark.sql.functions.struct
import org.apache.spark.sql.{Dataset, Encoder, Row}
import ai.rubik.abris.examples.utils.ExamplesUtils._
...
object KafkaAvroWriter {
  ...
  private def toAvro(dataFrame: Dataset[Row], properties: mutable.Map[String, String]) = {
    ...
    import ai.rubik.abris.avro.functions._
